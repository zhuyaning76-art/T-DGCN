...
GRAPH_PKL_PATH = "/home/zhu/桌面/Zhu/LSTTN-z/datasets/sensor_graph/adj_mx_04.pkl"
NUM_NODES = 307
...
CFG.MODEL.PARAM.DGCN = EasyDict()
CFG.MODEL.PARAM.DGCN.GWNET = {
    "num_nodes": NUM_NODES,
    "supports": [torch.tensor(i) for i in adj_mx],
    "c_in": 3,
    "c_out": 64,
...
CFG.TRAIN.DATA.DIR = "/home/zhu/桌面/Zhu/LSTTN-z/datasets/PEMS04"
...
CFG.MD5 = 'slfjlshglsljtlsljflsjlkfdj'
